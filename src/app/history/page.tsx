...
export default function HistoryPage() {
    ...
    // Grouping Transaksi Berdasarkan Tanggal (Group by Date)
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <header className={`flex flex-col md:flex-row md:items-center justify-between gap-4 p-5 md:p-6 rounded-3xl border backdrop-blur-xl ${cardClass}`}>
                    ...
                    <div className="flex items-center justify-between md:justify-end gap-3">
                        <nav className="flex items-center p-1.5 rounded-2xl border bg-zinc-950/40 border-zinc-800/80 gap-1">
                            <Link
                                href="/"
                ...
                {/* MIKRO-KARTU STATISTIK RINGKAS (SUMMARY CARDS) 📊 */}
                                    ...
                                    {groupedData[dateGroup].map((t) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                {/* Nominal dengan Aksen Warna Jelas (Hijau untuk Masuk, Merah/Pink Soft untuk Keluar) */}
